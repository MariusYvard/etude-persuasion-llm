...
Un défaut de forme s'ajoute pour la grille 2 elle-même : dans le catalogue du canal 2 (section 7 du préenregistrement), les tableaux "Amérique du Nord" et "Asie du Sud" ne comportent pas de colonne Niveau (le niveau y est seulement affirmé en préambule, "tous de niveau A"), alors que les cinq autres tableaux de zone en comportent une par ligne.
...
- **Les trois anomalies de fiches bibliographiques relevées en section 6** figurent encore comme case non cochée dans l'état des décisions du préenregistrement au 31 juillet 2026.
